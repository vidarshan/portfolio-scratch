...
import { SiGmail, SiGithub, SiStackoverflow } from "react-icons/si";
  ...
  return (
    <Container style={{ minHeight: "100vh" }}>
      <Text weight={600} size={largeScreen ? 40 : 25}>
        ...
        <Card mt={50} shadow="xl" padding="sm" radius="lg">
          <Flex
            sx={{ marginBottom: 10 }}
            align="center"
              ...
              <Flex sx={{ marginLeft: 10 }} direction="row" align="center">
                  ...
                  {colorScheme === "light" ? (
                    <Tooltip label="Github" withArrow>
                      <Githublight>
                        <BiGitBranch color="#fff" style={{ marginRight: 4 }} />
                    ...
                    <Githubdark>
                      <BiGitBranch color="#e9ecef" style={{ marginRight: 4 }} />
